-- =========================================================
-- Module      : Assemblage_V2
-- Description : Structural top-level assembly of the second
--               FPGA version of the project.
--
--               This version adds a 1 Hz clock enable block
--               to the Fibonacci generator in order to slow
--               down the sequence update for human-readable
--               display on the 7-segment outputs.
--
--               The generated 16-bit Fibonacci value is split
--               into four 4-bit groups and displayed in
--               hexadecimal on four 7-segment displays.
--
-- Inputs:
...
architecture structur of Assemblage_V2 is

    -- Internal 16-bit bus carrying the current Fibonacci value
    signal data   : STD_LOGIC_VECTOR(15 downto 0);

    -- 1 Hz enable signal generated from the system clock
    ...
    -- Clock divider / pulse generator used to create an
    -- approximately 1 Hz enable signal from the board clock
